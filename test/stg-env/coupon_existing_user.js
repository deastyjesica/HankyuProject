...
describe('E2E UPBOND HANKYU COUPON STG', function(){
    this.timeout(200000);
    let driver;
    ...
    it('03. Check if it’s possible to register on COUPON site after scanning a new VIP QR code, but without clicking "New Member," then accessing the coupon site', async function(){
        ...
        // try {
            await driver.get('https://stg.vip.hankyu-hanshin-dept.co.jp/?member_no=714-1-076498&rank=silver&signature=6b6b5922e3edba98796390629fb1eea7aee86f1dc57e3634d8e7f68bdc065899');
            await driver.manage().window().maximize();
