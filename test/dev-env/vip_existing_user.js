...
describe('E2E UPBOND HANKYU VIP DEV', function(){
    this.timeout(200000);
    let driver;
    ...
    it('01. Login Existing User & Check Dashboard', async function(){
        ...
        // try {
            await driver.get('https://dev.vip.hankyu-hanshin-dept.co.jp/');
            ...
            await driver.wait(until.elementLocated(By.xpath('//div[text()="Overseas Customer’s VIP Club Introduction to Services Offered"]')), 8000);
